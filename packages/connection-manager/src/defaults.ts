...
const defaultOMOPConnections = () => {
  ...
  return [
    ...
    {
      name: "Local Docker Cohort Definition Service",
      id: uuid(),
      url: `http://localhost:4321/api/v1/omop/cohortdefinition`,
      codeProperty: "code",
      webApiUrl: "http://omop.phema.science/WebAPI/",
      statementName: "In Initial Population",
      source: "OHDSI-CDMV5",
    ...
    },
    {
      ...
      id: uuid(),
      url: `http://localhost:4321/api/v1/omop/cohortdefinition/report`,
      codeProperty: "code",
      webApiUrl: "http://omop.phema.science/WebAPI/",
      statementName: "In Initial Population",
      source: "OHDSI-CDMV5",
    ...
    },
    {
      ...
      id: uuid(),
      url: `http://localhost:4321/api/v1/omop/cohortdefinition/sql`,
      codeProperty: "code",
      webApiUrl: "http://omop.phema.science/WebAPI/",
      statementName: "In Initial Population",
      source: "OHDSI-CDMV5",
